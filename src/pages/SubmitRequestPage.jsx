  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] font-manrope">
      ...
      <main className="max-w-5xl mx-auto px-10 pt-32 pb-20">
        <div className="mb-10">
          <h1 className="text-4xl font-extrabold text-gray-900 mb-2">Submit a Request</h1>
        ...
        <form className="bg-white p-12 rounded-[2.5rem] shadow-sm border border-gray-50 space-y-8">
          ...
          <div className="space-y-3">
            <label className="text-[11px] font-bold text-gray-400 uppercase tracking-[0.2em] ml-1">Subject</label>
            <input 
              type="text" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-3">
              <label className="text-[11px] font-bold text-gray-400 uppercase tracking-[0.2em] ml-1">Topic</label>
            ...
            <div className="space-y-3">
              <label className="text-[11px] font-bold text-gray-400 uppercase tracking-[0.2em] ml-1">NIM</label>
              <input 
                type="text" 
          ...
          <div className="space-y-3">
            <label className="text-[11px] font-bold text-gray-400 uppercase tracking-[0.2em] ml-1">Detailed Description</label>
            <textarea 
              rows="5" 
          ...
          {/* Upload Section */}
          <div className="space-y-3">
            <label className="text-[11px] font-bold text-gray-400 uppercase tracking-[0.2em] ml-1">Attachments (Optional)</label>
